...
void lcd_set_slow(void)
{

	//S
	LCD->WF8B[LCD_Frontplane_Pin[0]] = LCD_SEG_D | LCD_SEG_F| LCD_SEG_G;
	LCD->WF8B[LCD_Frontplane_Pin[1]] = LCD_SEG_A | LCD_SEG_C;
	...
	LCD->WF8B[LCD_Frontplane_Pin[4]] = LCD_SEG_D | LCD_SEG_E |LCD_SEG_F;
    	...
    	//W (U)
    	LCD->WF8B[LCD_Frontplane_Pin[6]] = LCD_SEG_D | LCD_SEG_E |LCD_SEG_F;
	LCD->WF8B[LCD_Frontplane_Pin[7]] = LCD_SEG_B | LCD_SEG_C;
}


void lcd_set_fast(void)
{

	//F
	LCD->WF8B[LCD_Frontplane_Pin[0]] = LCD_SEG_E |LCD_SEG_F| LCD_SEG_G;
	LCD->WF8B[LCD_Frontplane_Pin[1]] = LCD_SEG_A;
	...
	//T
	LCD->WF8B[LCD_Frontplane_Pin[6]] = LCD_SEG_D | LCD_SEG_E |LCD_SEG_F| LCD_SEG_G;
